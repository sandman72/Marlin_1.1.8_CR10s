...
## Marlin 1.1.8 for Creality CR-10S 300 with BL-Touch Sensor

This is a remix of the original Creality Marlin Repository and the newer Marlin 1.1.8 version. It includes support for the BL-Touch bedleveling sensor, has the creality graphics layout, thermal runaway protection and standard CR-10S settings incorporated. (1.1.8 April 2018) 
